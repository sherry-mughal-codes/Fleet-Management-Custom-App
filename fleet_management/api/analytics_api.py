...
def get_executive_dashboard_api(company: str | None = None) -> Dict[str, Any]:
...
@api_endpoint(allow_guest=False)
def get_kpis_api(company: str | None = None) -> Dict[str, Any]:
...
@api_endpoint(allow_guest=False)
def get_alerts_api(company: str | None = None) -> Dict[str, Any]:
...
@api_endpoint(allow_guest=False)
def get_charts_api(company: str | None = None) -> Dict[str, Any]:
...
@api_endpoint(allow_guest=False)
def get_vehicle_health_table_api(company: str | None = None, limit: int = 20) -> Dict[str, Any]:
...
@api_endpoint(allow_guest=False)
def get_recent_activity_api(company: str | None = None, limit: int = 10) -> Dict[str, Any]:
