...
@api_endpoint(allow_guest=False)
def get_company_cost_summary_api(company: Optional[str] = None, period: str = "lifetime") -> Dict[str, Any]:
...
@api_endpoint(allow_guest=False)
def get_monthly_cost_api(company: Optional[str] = None, year: Optional[int] = None, month: Optional[int] = None) -> Dict[str, Any]:
...
@api_endpoint(allow_guest=False)
def get_yearly_cost_api(company: Optional[str] = None, year: Optional[int] = None) -> Dict[str, Any]:
