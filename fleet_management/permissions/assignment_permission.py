...
class AssignmentPermissionEvaluator:
	...
	@staticmethod
	def can_create_assignment(user: Optional[str] = None) -> bool:
	...
	@staticmethod
	def can_approve_assignment(user: Optional[str] = None) -> bool:
	...
	@staticmethod
	def require_approval_permission(user: Optional[str] = None):
