...
class VehicleValidator(BaseValidator):
	...
	ALLOWED_STATUS_TRANSITIONS = {
		...
		VehicleStatus.MAINTENANCE_DUE: [VehicleStatus.UNDER_MAINTENANCE, VehicleStatus.AVAILABLE, VehicleStatus.ASSIGNED, VehicleStatus.OUT_OF_SERVICE],
		VehicleStatus.UNDER_MAINTENANCE: [VehicleStatus.INSPECTION, VehicleStatus.AVAILABLE, VehicleStatus.ASSIGNED, VehicleStatus.OUT_OF_SERVICE],
